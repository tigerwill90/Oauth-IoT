...
CREATE TABLE IF NOT EXISTS `oauth`.`clients` (
  ...
  `cli_client_id` VARCHAR(80) NOT NULL,
  ...
  PRIMARY KEY (`cli_id`),
  UNIQUE INDEX `cli_client_id_UNIQUE` (`cli_client_id` ASC))
ENGINE = InnoDB;
