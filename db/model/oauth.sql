...
START TRANSACTION;
USE `oauth`;
INSERT INTO `oauth`.`resources` (`res_id`, `res_identification`, `res_secret`, `res_audience`, `res_registration_date`, `res_pop_method`, `res_key_size`, `res_algorithm_encryption`, `res_tls`, `res_transmission_algorithm`) VALUES (1, '012345', '0123456789012345', 'iot_1', NULL, 'introspection', 16, 'AES128-ECB', 0, 'AES128-ECB');
...
START TRANSACTION;
USE `oauth`;
INSERT INTO `oauth`.`users` (`use_id`, `use_username`, `use_email`, `use_password`, `use_refresh_token`) VALUES (1, 'tigerwill90', 'c@c.com', '%6s9VVxT4SV}8qBe', 1);
...
START TRANSACTION;
USE `oauth`;
INSERT INTO `oauth`.`resources_scopes` (`res_sco_id`, `res_sco_service`, `res_sco_description`, `res_sco_uri`, `res_sco_name`, `res_sco_method`, `res_sco_res_id`) VALUES (1, 'Rweather', 'Read the temperature', 'http://192.168.192.0/weather', 'Read weather', 'GET', 1);
INSERT INTO `oauth`.`resources_scopes` (`res_sco_id`, `res_sco_service`, `res_sco_description`, `res_sco_uri`, `res_sco_name`, `res_sco_method`, `res_sco_res_id`) VALUES (2, 'Wweather', 'Write something cool', 'http://192.168.192.0/weather', 'Write weather', 'POST', 1);
INSERT INTO `oauth`.`resources_scopes` (`res_sco_id`, `res_sco_service`, `res_sco_description`, `res_sco_uri`, `res_sco_name`, `res_sco_method`, `res_sco_res_id`) VALUES (3, 'Dweather', 'Delete something', 'https://192.168.192.0/weather', 'Delete weather', 'DELETE', 1);
