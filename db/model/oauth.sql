...
START TRANSACTION;
USE `oauth`;
INSERT INTO `oauth`.`resources_scopes` (`res_sco_id`, `res_sco_service`, `res_sco_description`, `res_sco_uri`, `res_sco_name`, `res_sco_method`, `res_sco_res_id`) VALUES (1, 'read:weather', 'Read the temperature', 'http://192.168.192.0/weather', 'Read weather', 'GET', 1);
INSERT INTO `oauth`.`resources_scopes` (`res_sco_id`, `res_sco_service`, `res_sco_description`, `res_sco_uri`, `res_sco_name`, `res_sco_method`, `res_sco_res_id`) VALUES (2, 'write:weather', 'Write something cool', 'http://192.168.192.0/weather', 'Write weather', 'POST', 1);
INSERT INTO `oauth`.`resources_scopes` (`res_sco_id`, `res_sco_service`, `res_sco_description`, `res_sco_uri`, `res_sco_name`, `res_sco_method`, `res_sco_res_id`) VALUES (3, 'delete:weather', 'Delete something', 'https://192.168.192.0/weather', 'Delete weather', 'DELETE', 1);
